...
import { Upload, Github, Globe, Image, Tag, Mail, FileText, CheckCircle, Clock, XCircle, ChevronDown, ChevronUp, Send, Bot } from 'lucide-react';
            ...
            {submissions.map(sub => {
              ...
              return (
                <motion.div
                  key={sub.id}
                  layout
                  className={`rounded-xl border bg-black/40 overflow-hidden ${meta.bg}`}
                >
                  <button
